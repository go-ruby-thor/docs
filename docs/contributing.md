...
Contributions are welcome. `go-ruby-thor/thor` is built to a small set of
...
The library is in [`github.com/go-ruby-thor/thor`](https://github.com/go-ruby-thor/thor).
This documentation site is in [`github.com/go-ruby-thor/docs`](https://github.com/go-ruby-thor/docs).
