# go-ruby-thor documentation

**Pure-Go (CGO=0) MRI-faithful Ruby thor**

`go-ruby-thor/thor` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `thor`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-thor/thor`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `thor`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-thor/thor
```
...
| Repo | What it is |
| --- | --- |
| [`thor`](https://github.com/go-ruby-thor/thor) | the library — Ruby's `thor` in pure Go |
| [`docs`](https://github.com/go-ruby-thor/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-thor.github.io`](https://github.com/go-ruby-thor/go-ruby-thor.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-thor/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-thor/thor](https://github.com/go-ruby-thor/thor).
