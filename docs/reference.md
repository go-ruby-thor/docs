...
The public API lives at the module root (`github.com/go-ruby-thor/thor`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `thor`, while the surface follows
...
```go
import "github.com/go-ruby-thor/thor"
```
...
- **[pkg.go.dev/github.com/go-ruby-thor/thor](https://pkg.go.dev/github.com/go-ruby-thor/thor)**

The module's [README](https://github.com/go-ruby-thor/thor#readme) carries worked
